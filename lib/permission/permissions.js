...
const Permissions = Object.seal(Object.freeze(Object.preventExtensions({
	...
	MANAGE_BOARD_TRUSTED: 36,
	_MANAGE_BOARD_BITS: [30,31,32,33,34,35,36], //bits that can be set by a BO and partial bitfield will be stored in board staff object
...
const Metadata = Object.seal(Object.freeze(Object.preventExtensions({
	...
	[Permissions.MANAGE_BOARD_TRUSTED]: { label: 'Trusted Users', desc: 'Access to trusted user management.', parents: [Permissions.MANAGE_BOARD_OWNER] },
